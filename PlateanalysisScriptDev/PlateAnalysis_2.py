...
class PlateDataset():
    def __init__(self,path, column):
        ...
        self.concs = np.array([1000./(2**i) for i in range(1,9)])
    def GetPlateData(self):
        ...
        data.drop(['WellLetter','WellNumber'],inplace=True) # Don't need these anymore
    ...
    def select_traces(self, selection):
        ...
        def plotPlateData(self,data, compound, concs,save=False):
    '''
...
def main():
    ...
    whatCompoundInWhatColumn={1:'DMSO 1',2:'Arachadionic acid 1',
    3:'Arachadionic acid 2',4:'Arachadionic acid 3',
    5:'Lauric acid 1',6:'Lauric acid 2',7:'Lauric acid 3',
    8:'Palmitic acid 1',9:'Palmitic acid 2',10:'Palmitic acid 3',
    11:'SDS 1',12:'SDS 2',13:'SDS 3',
    14:'4-PhenylImidazole 1',15:'4-PhenylImidazole 2',16:'4-PhenylImidazole 3'}
