...
path = '~/Documents/Work/201906_PlateAssayDevelopment/3_TestFattyAcids/'+'20190607_BM3conccheck.csv'
...
class dataset:
    ...
    def plot_traces(self):
        ...
        plt.title('P450 BM3 Wild Type Heme domain Concentration Check - 7th June 2019')
        plt.show()
