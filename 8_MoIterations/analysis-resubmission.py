...
def main(args):
    ...
    experiments = {
            1: {
                "file": "20190626_plate1.CSV",
                'protein_concentration': 7.09,
                'columns': plate_format,
                },
            2: {
                "file": "20190626_plate2.CSV",
                'protein_concentration': 14.09,
                'columns': plate_format,
                },
            3: {
                "file": "20190626_plate3.CSV",
                'protein_concentration': 27.56,
                'columns': plate_format,
                },
    }
    ...
    for plate_name in experiments.keys():
        ...
        for column_num in columns:
            ...
            o.append({
                ...
                'protein_concentration': experiment.get('protein_concentration'),
                **constants,
                }
                     )
