...
file = '20190806.CSV'
protconc=27.56 #27.56 #7.09, 14.09
count=0
...
for i in range(1,len(titles)+1):
    ...
    #plotPlateDifferenceSpectra(data,pureprotein_andDMSO,str(protconc)+' uM BM3 '+titles[count],concs,save=True)
    #Plot_MichaelisMenten(diffdiff, concs,str(protconc)+' uM BM3 '+titles[count],save=True)
    count+=1
