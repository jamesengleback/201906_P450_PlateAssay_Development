...
class PlateDataset():
    def __init__(self,plate_data, pathlength_data, pathlength_corr = False):
        ...
        # Pathlength Stuff
        self.pathlength_corr = pathlength_corr
    ...
    def NormalizeBlock(self,testWells, BlankWells):
        ...
        if self.pathlength_corr:
            testWells = testWells.div(testPathlengths,axis = 'index') # Correcting for pathlength
            BlankWells = BlankWells.div(blankPathLenths,axis = 'index')
